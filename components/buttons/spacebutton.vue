<template>
  <div class="container noselect">
    ...
    <button id="button">
      <p id="to-launch">To The Moon!</p>
      <p id="tag">❤️ &lt;3</p>
      <div id="platform"></div>
      <div class="caution">
        <div id="caution-left">Let Go!</div>
        ...
        <g id="c">
          ...
          <g>
            ...
            >
              ...
              <tspan style="letter-spacing: -0.01em" y="0" x="14.3">n</tspan>
            ...
            <polygon
              style="fill: url(#bf); opacity: 0.82"
...
#clickHandler:hover ~ #button {
  ...
  -webkit-box-shadow: 2px 2px 0 2px #b2b2b2,
    -1px 0 28px 0 rgba(255, 250, 225, 0.512),
...
#caution-left {
  ...
  opacity: 0;
  -webkit-transform: translate3d(83px, 0px, 0px) rotateX(0deg) rotateY(0deg)
    rotateZ(-90deg);
  transform: translate3d(83px, 0px, 0px) rotateX(0deg) rotateY(0deg)
    rotateZ(-90deg);
}
...
#caution-right {
  ...
  transition: 200ms ease;
  opacity: 0;
  -webkit-transform: translate3d(0px, 62px, 0px) rotateX(0deg) rotateY(0deg)
    rotateZ(0deg);
  transform: translate3d(0px, 62px, 0px) rotateX(0deg) rotateY(0deg)
    rotateZ(0deg);
}
